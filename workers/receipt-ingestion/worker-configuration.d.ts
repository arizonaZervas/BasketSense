/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/receipt-ingestion/worker-configuration.d.ts --config workers/receipt-ingestion/wrangler.jsonc --env staging` (hash: be93eee495704c2e80b2c325db28703d)
...
interface __BaseEnv_Env {
	...
	RECEIPT_INGESTION: Workflow<Parameters<import("./src/index").ReceiptIngestionWorkflow['run']>[0]['payload']>;
	TRIP_REPORT: Workflow<Parameters<import("./src/index").TripReportWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GEMINI_MODEL" | "GEMINI_IMAGE_MODEL" | "EMAIL_FROM" | "APP_URL">> {}
}
