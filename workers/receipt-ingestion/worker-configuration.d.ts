/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/receipt-ingestion/worker-configuration.d.ts --config workers/receipt-ingestion/wrangler.jsonc --env staging` (hash: d85294cf242f760d0c022454d9afe668)
