/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/receipt-ingestion/worker-configuration.d.ts --config workers/receipt-ingestion/wrangler.jsonc --env staging` (hash: 2616eb5797f5f3994b2ba017b5cb59b7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GEMINI_MODEL" | "EMAIL_FROM">> {}
}
