/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config workers/receipt-ingestion/wrangler.jsonc --env staging` (hash: f0ec82611bbae2d564c2af7ecc176994)
...
interface __BaseEnv_Env {
	...
	EMAIL_FROM: "receipts@goodcartday.com";
	APP_URL: "https://basket-sense-household.nysha-enterp-3913.chatgpt.site";
	RECEIPT_INGESTION: Workflow<Parameters<import("./workers/receipt-ingestion/src/index").ReceiptIngestionWorkflow['run']>[0]['payload']>;
	TRIP_REPORT: Workflow<Parameters<import("./workers/receipt-ingestion/src/index").TripReportWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/receipt-ingestion/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GEMINI_MODEL" | "EMAIL_FROM" | "APP_URL">> {}
}
